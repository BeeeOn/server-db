...
\set query_identity '$$ '`cat queries/roles_in_gateway/can_see_identity.sql`' $$'
\set query_verified_identity '$$ '`cat queries/roles_in_gateway/can_see_verified_identity.sql`' $$'
