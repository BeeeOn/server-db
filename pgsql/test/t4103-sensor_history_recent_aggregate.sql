...
\set query_raw $$ `cat queries/sensors_history/huge_fetch_raw.sql`; $$
\set query_agg $$ `cat queries/sensors_history/huge_fetch_agg.sql`; $$
...
SELECT results_eq(
	...
	$$ VALUES
		...
		(timestamp '2017-7-20 13:00:10', (21 + 22)::real / 2::real, 21::real, 22::real),
		(timestamp '2017-7-20 13:00:20', (23 + 24)::real / 2::real, 23::real, 24::real),
...
SELECT
	...
	to_device_id(11678152912333531137::numeric(20, 0)),
	0,
	timestamp '2017-7-20 13:00:00' + ((i - 1) * interval '5 seconds'),
	random()::real
...
SELECT results_eq(
	...
	SELECT
		timestamp '2017-7-20 13:00:00' + ((r.i - 1) * interval '10 seconds'),
